# This function is written to get list of EC2 instances that are in 'running' state and stop them.
...
for instances in reservations_list:
	...
	if instance_state == 'running':
		print(instance_id ,"will be stopped")
		InstanceIdsList.append(instance_id)

# Check whether list is empty
if not InstanceIdsList:
	print("InstanceIdsList is empty, cannot perform stop operation")
else:
	print("Stopping all the instances with instance ids: ",InstanceIdsList)
	ec2.stop_instances(InstanceIds=InstanceIdsList)
