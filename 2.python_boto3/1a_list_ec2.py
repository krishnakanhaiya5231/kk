...
#
https://boto3.amazonaws.com/v1/documentation/api/1.9.42/reference/services/ec2.htm
1#EC2.Client.describe_instances
...
print('ec2 Information is',Myec2)
#for res in Myec2['Reservations']:
#print(res)
