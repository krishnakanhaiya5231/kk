...
print("-----------------------------------------")
# Define a empty list which will have instance id
InstanceIdsList=[]
# iterate through every instance object and find instance id and instance state, append instance id value in list only if the instance is stopped
